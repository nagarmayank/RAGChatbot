...
def supervisor_agent():
    ...
    supervisor_agent = create_supervisor(
        ...
        prompt="You are a supervisor responsible for delegating tasks. \" \
            If the question is complex, break down the tasks and assign task to individual agents\
            ...
            rag_agent is for searching relevant information in the vector database related to Artificial Intelligence, \" \
            search_agent is for general web searches and latest news, \" \
